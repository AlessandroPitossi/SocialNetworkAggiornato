...
public class ExcelUtility {
	...
	private static final String PART_MAX_RAGGIUNTI="\nCi dispiace, ma è già stato raggiunto il numero massimo di iscritti possibili";
	...
	private static boolean iscrAccettabile(Utente u, Evento e) {
		...
		boolean ok=mylib.Utility.accettabile(utentiIscr, u.getId(), GIA_ISCRITTO)&&
				e.getUtenti().size()<e.getNumPart();
		if(e.getUtenti().size()==e.getNumPart()) System.out.println(BelleStringhe.aCapo(PART_MAX_RAGGIUNTI, LARGHEZZA));
		return ok;
	}
