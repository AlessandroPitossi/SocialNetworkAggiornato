...
public class ExcelReader{
	...
	public static void addSheet(String fileName) {
		Sheet s=getSheet(new File(fileName), FIRST_PAGE);
		Workbook workbook=s.getWorkbook();
		Sheet newSheet=workbook.createSheet();
		writeFile(new File(fileName), newSheet);
		chiudi();
	}
	...
	public static void main(String[] args) {
		addToCell("31/03/2019", Evento.FILE_EV, 2, 5, 0);
		addToCell("31/03/2019", Evento.FILE_EV, 2, 7, 0);
		addToCell("31/03/2019", Evento.FILE_EV, 2, 12, 0);
		addToCell("31/03/2019", Evento.FILE_EV, 2, 16, 0);
		addToCell("2", Evento.FILE_EV, 2, Evento.EVENT_NUM_PART_ROW, 0);
	}
}
