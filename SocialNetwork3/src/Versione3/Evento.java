...
public class Evento {
	...
	private static final String DESCR_TERMINE_RITIRO_ISCR="Data entro cui a ogni fruitore che ha aderito all’evento è concesso di cancellare la sua iscrizione e al fruitore che ha proposto l’evento di ritirare la proposta";
	...
	private static final int TOLLERANZA_MIN=0;
	...
	private static final String[] CAMPI_INT= {NUM_PART, TOLLERANZA_PARTECIPANTI};
	private static final String[] CAMPI_DOUBLE= {QUOTA};
	private static final String[] CAMPI_DATE= {TERM_ULT_ISCR, DATA, DATA_FIN, TERMINE_RITIRO_ISCR};
	...
	private static final String CAMPO_ERRATO="Il campo cercato non è di tipo ";
